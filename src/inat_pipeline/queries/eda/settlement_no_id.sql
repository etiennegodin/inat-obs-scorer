...
CREATE OR REPLACE TABLE eda.settlement_no_id AS
...
JOIN features.identifications_at_window iw ON w.observation_id = iw.observation_id
WHERE iw.has_any_id IS FALSE
GROUP BY w.days
ORDER BY w.days
