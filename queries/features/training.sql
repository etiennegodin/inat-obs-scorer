...
SELECT
    ...
    ob.rg_rate_lifetime,
    ob.rg_rate_last_12m,
    ob.rg_rate_is_reliable,
    ob.observer_reputation_score,
    ob.taxon_diversity_family,
    ob.taxon_diversity_genus,
    ob.taxon_diversity_species,
    ob.avg_photo_count,
    ob.pct_obs_with_description,
    ob.pct_obs_with_license,
    ob.pct_obs_from_mobile,
    ob.has_orcid,
    ob.sampling_pool,
